...
- **Memorable moment:** the instructor first viewport is a four-part situation ledger—Now, Next, At risk, Changed—followed by one prioritized move; the student first viewport is a clean three-course dispatch board.
...
- **Unresolved decisions:** BUEN units/final/grading questions remain visibly unresolved in the private source layer and may not be promoted into confident student copy.
...
| First viewport | Masthead, four equal situation columns, one prioritized move | Semantic HTML/CSS grid |
